...
Uses the [Unity](https://github.com/ThrowTheSwitch/Unity) test framework. Test files are in `tests/`, with runners auto-generated via a Ruby script from `scripts/unity/`.
